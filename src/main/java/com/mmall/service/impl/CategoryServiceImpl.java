...
/*      System.out.println((categoryIdList) + "----------categoryIdList------------");
        System.out.println(JSON.toJSON(categoryIdList) + "----------toJSON------------");
        String xx = JSON.toJSONString(categoryIdList);
        System.out.println(xx + "----------toJSONString------------");
        System.out.println(JSON.parse("{\"name\":\"John\", \"age\":20,\"grade\":{\"course\":\"English\",\"score\":100,\"level\":\"A\"}}") + "----------JSON.parse(xx)------------");
        System.out.println(JSON.parseArray(xx) + "----------JSON.parse(xx)------------");
*/
